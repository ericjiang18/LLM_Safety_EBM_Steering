...
class ModelBase(ABC):
    def __init__(self, model_name_or_path: str,  system: str = None):
    ...
    def generate_completions(self, dataset, fwd_pre_hooks=[], fwd_hooks=[], batch_size=8, max_new_tokens=64, system=None):
